...
var server = "shopping-craigpetersme.database.windows.net"
var port = 1433
var user = "shopping-craigpetersme"
var password = "Ogsogology!123"
var database = "shopping-craigpetersme"

func main() {
	// Build connection string
	connString := fmt.Sprintf("server=%s;item id=%s;password=%s;port=%d;database=%s;",
